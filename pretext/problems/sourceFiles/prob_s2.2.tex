...
moving water at the point $(x,y)$ in the first quadrant of the $xy$-plane.
  \begin{center}
       \includegraphics{fig/duckyField.pdf}
  \end{center}
...
\begin{answer} 
\begin{center}
       \includegraphics{fig/duckyField2.pdf}
  \end{center}
\end{answer}
...
(b) 
  \begin{center}
       \includegraphics{fig/OE10A_1.pdf}
  \end{center}
...
also sketched (in blue) in the figure on the right below.
  ...
  \begin{center}
       \includegraphics{fig/OE10A_1Sign.pdf}\qquad\qquad
       \includegraphics{fig/OE10A_1.pdf}
  \end{center}
