...
\end{itemize}
\begin{center}
     \includegraphics{fig/square.pdf}
\end{center}
So
\begin{align*}
...
\begin{center}
      (a) \raisebox{-1.0\height}{\includegraphics{fig/VFa.pdf}}\qquad
      (b) \raisebox{-1.0\height}{\includegraphics{fig/VFb.pdf}}\qquad
\end{center}
\begin{center}
      (c) \raisebox{-1.0\height}{\includegraphics{fig/VFc.pdf}}\qquad
      (d) \raisebox{-1.0\height}{\includegraphics{fig/VFd.pdf}}\qquad
\end{center}
\end{question}
...
\begin{center}
      (a) \raisebox{-1.0\height}{\includegraphics{fig/VFas.pdf}}\qquad
      (b) \raisebox{-1.0\height}{\includegraphics{fig/VFbs.pdf}}\qquad
\end{center}
\smallskip
...
\begin{center}
      (c) \raisebox{-1.0\height}{\includegraphics{fig/VFcs.pdf}}\qquad
      (d) \raisebox{-1.0\height}{\includegraphics{fig/VFd.pdf}}\qquad
\end{center}
...
\begin{center}
       \includegraphics{fig/OE10D_2.pdf}
\end{center}
\noindent
we parametrize $C$ by 
\begin{equation*}
...
\begin{center}
       \includegraphics{fig/OE06D_1.pdf}
\end{center}
...
$L_4$ as in the figure
 ...
 \begin{center}
       \includegraphics{fig/OE11D_4.pdf}
\end{center}
...
\begin{solution} (a)
	...
	\begin{center}
		...
		\end{tikzpicture}
		%       \includegraphics{fig/OE12D_3.pdf}%arrow points in wrong direction for L
	\end{center}
...
%\begin{center}
%   \includegraphics{fig/OE01DQ2.pdf}
%\end{center}
...
\begin{center}
   \includegraphics{fig/OE00A_2.pdf}
\end{center}
