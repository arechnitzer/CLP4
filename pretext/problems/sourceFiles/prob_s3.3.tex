...
\begin{center}
     \includegraphics{fig/cylinderQ.pdf}
\end{center}
...
\begin{center}
          \includegraphics{fig/coneCylA.pdf}\qquad\qquad
          \includegraphics{fig/coneCyl.pdf}
\end{center}
...
\end{align*}
\begin{center}
       \includegraphics{fig/cubeDTT.pdf}
\end{center}
...
\vadjust{
     \begin{center}
          \includegraphics{fig/sphericalX.pdf}
     \end{center}
...
\begin{center}
       \includegraphics{fig/OE06D_3.pdf}
\end{center}
...
\raisebox{-25pt}[0pt][5pt]{\includegraphics{fig/OE05D_6.pdf}}
\end{equation*}
and
\begin{align*}
\dblInt_S \vF\cdot\hn\, \dee{S}
...
\begin{center}
    \includegraphics{fig/revEnd.pdf}
\end{center}
...
%the first octant.
%\begin{center}
%     \includegraphics[scale=0.90]{fig/OE12J_6.pdf}
%\end{center}
...
circle.
\begin{center}
     \includegraphics[scale=0.90]{fig/OE16D_7.pdf}
\end{center}
...
is sketched below
\begin{center}
     \includegraphics{fig/OE03A_4.pdf}
\end{center}
So the mass is
\begin{align*}
...
\begin{center}
    \includegraphics{fig/applecore.pdf}
\end{center}
...
\begin{center}
    \includegraphics{fig/OE11A_7ai.pdf}
\end{center}
...
\begin{center}
    \includegraphics{fig/OE11A_7aii.pdf}
\end{center}
...
\begin{center}
    \includegraphics{fig/OE11A_7aiii.pdf}
\end{center}
