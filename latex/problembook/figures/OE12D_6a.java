...
public class OE12D_6a extends Template {

     static {templateClass = new OE12D_6a() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fLine3d(0,yt,0, 0,3,0) ;
          fLine3d(0,0,zt, 0,0,3) ;
          ...
          double dth = 1 ; double dthRad = dth*Math.PI/180 ;
          double y1 = 3*Math.cos(thRad+dthRad) ; double z1 = 3*Math.sin(thRad+dthRad) ; 
          double y2 = 3*Math.cos(thRad-dthRad) ; double z2 = 3*Math.sin(thRad-dthRad) ; 
          fArrow3d(5,y1,z1,  5,y2,z2) ;
          fTeXlabel3d(5,y1-0.2,z1, "tr", "$\\partial S$") ;
