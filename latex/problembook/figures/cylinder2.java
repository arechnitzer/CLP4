...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fEnv("psFillGray", 0.8) ;
          fCurve(new circ3d(proj,   0,Y,0, 0,0,r, r,0,0),
                      0,90,FILLED)  ;
          {  double[] xlist = {0, r, r/Math.sqrt(2), 0} ;
             double[] ylist = {Y, Y, Y, Y} ;
             double[] zlist = {0, 0, r/Math.sqrt(2), r} ;
          ...
          fTeXlabel3d(0,Y,zm, "cb", "$y=3$") ;
          fTeXlabel3d(0,ym+3,0, "cl", "$y$") ;
          fTeXlabel3d(xm,-1,-1, "tr", "$x$") ;
          fTeXlabel3d(0,-15,10, "cr", "$x^2+z^2=4$") ;
          ...
          fCurve(new circ3d(proj,   0,Y,0, 0,0,r, r,0,0),
                      0,90,OPEN)  ;
          fLine3d(0,0,r, 0,Y,r) ;
          fTeXlabel3d(0,Y/2.0,r+4, "cb", "$S$") ;
          fLine3d(r,0,0, r,Y,0) ;
          fEnv("lineWidth", 0.5) ;
          fEnv("headHalfWidth", 2.0*1.4) ;
          fEnv("headLength", 6.0*1.4) ;
          fArrow3d(X,Y,Z, X,Y+30,Z) ;
          fTeXlabel3d(X,Y+27,Z+4, "cb", "$\\hj$") ;
          canvas.append( new fPsWrite("[2 2] 1.0 setdash\n")) ;
          fLine3d(X,0,Z, X,-6,Z) ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          fArrow3d(X,-6,Z, X,-30,Z) ;
          fTeXlabel3d(X,-30,Z+4, "cb", "$-\\hj$") ;

          fTeXlabel3d(0,Y/2,Z/2, "cc", "$V$") ;
          fTeXlabel3d(X/2-8,Y,-10, "ct", "$D_r$") ;
          fTeXlabel3d(2,-8,Z, "br", "$D_l$") ;
