...
public class OE06A_6 extends Template {

     static {templateClass = new OE06A_6() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(0.5*r, -3, 0.8*r, "cr", "$S$") ;
          fTeXlabel3d(0.5*r, 0.5*r, r*zv-10, "tc", "$\\partial S$") ;
          fTeXlabel3d(0, 0.7*r, 0.8*r, "cl", "$x^2+y^2+z^2=2$") ;
          fTeXlabel3d(0, 0.3*r, r*zv+3, "cb", "$z=1$") ;

          fEnv("headHalfWidth", 2.0*1.5) ;
          fEnv("headLength", 6.0*1.5) ;
          fEnv("psFillColor", Red) ;
          phi = phi2 ;
          double th3a = 43 ; double th3b = 47 ;
          double x3a = r*Math.sin(phi*Math.PI/180)*Math.cos(th3a*Math.PI/180);
          double y3a = r*Math.sin(phi*Math.PI/180)*Math.sin(th3a*Math.PI/180);
          double z3a = r*Math.cos(phi*Math.PI/180);
          double x3b = r*Math.sin(phi*Math.PI/180)*Math.cos(th3b*Math.PI/180);
          double y3b = r*Math.sin(phi*Math.PI/180)*Math.sin(th3b*Math.PI/180);
          double z3b = r*Math.cos(phi*Math.PI/180);
          fArrow3d(x3a,y3a,z3a, x3b,y3b,z3b) ;
          ...
          phi = 30 ;
          double l = 30 ;
          double x4a = r*Math.sin(phi*Math.PI/180)*Math.cos(th4*Math.PI/180);
          double y4a = r*Math.sin(phi*Math.PI/180)*Math.sin(th4*Math.PI/180);
          double z4a = r*Math.cos(phi*Math.PI/180);
          double x4b = (r+l)*Math.sin(phi*Math.PI/180)*Math.cos(th4*Math.PI/180);
          double y4b = (r+l)*Math.sin(phi*Math.PI/180)*Math.sin(th4*Math.PI/180);
          double z4b = (r+l)*Math.cos(phi*Math.PI/180);
          fArrow3d(x4a,y4a,z4a, x4b,y4b,z4b) ;
          fTeXlabel3d(x4b,y4b+2,z4b, "cl", "$\\hn$") ;
