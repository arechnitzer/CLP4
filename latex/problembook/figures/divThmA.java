...
public class divThmA extends Template {

     static {templateClass = new divThmA() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
         ...
         {  double[] xlist = {0, 0, 0.7*Y, Y} ;
          ...
          fTeXlabel3d(0,ym+0.15,0, "cl", "$y$") ;
          fTeXlabel3d(xm+0.05,-0.05,0, "tr", "$x$") ;
          fTeXlabel3d(0, 0.37*Y,0.9*Z, "cl", "$z=\\frac{9-x^2-y^2}{9+x^2+y^2}$") ;
          fTeXlabel3d(0.55*Y, 0.95*Y,0, "cl", "$x^2+y^2=9$") ;
          fTeXlabel3d(0.45*Y, 0.5*Y,0, "cc", "$D$") ;
          fTeXlabel3d(0, 0.85*Y,0.45*Z, "cc", "$S$") ;
