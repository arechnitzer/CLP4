...
public class OE11A_4 extends Template {

     static {templateClass = new OE11A_4() ; }

     public void setup() {
          filePrefix = "OE11A_4" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
...
//          fArrow(0.2*R, -r, 0.2*R, -rr) ;
//          fTeXlabel(0.2*R+0.08, -rr+0.05, "lb", "$\\hn$") ;
