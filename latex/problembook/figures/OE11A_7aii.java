...
public class OE11A_7aii extends Template {

     static {templateClass = new OE11A_7aii() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(0, 0.7*r, 0.8*r, "cl", "$x^2+y^2+z^2=16$") ;
          fTeXlabel3d(0, 0.3*r, r*zv+3, "cb", "$\\scriptstyle z=2\\sqrt{2}$") ;
