...
public class OE17D_5 extends Template {

     static {templateClass = new OE17D_5() ; }
...
//     static double[] view = {fwd[0], fwd[1], fwd[2]} ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel3d(0,0,rrz+3, "cb", "$\\hat\\vB$") ;
          fTeXlabel3d(0,rry+3,0, "cl", "$\\hat\\vN$") ;
          fTeXlabel3d(rrx,-1,-1, "tr", "$\\hat\\vT$") ;
