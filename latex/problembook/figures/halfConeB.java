...
public class halfConeB extends Template {

     static {templateClass = new halfConeB() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(0, 0.6*Y,0.5*Z, "cl", "$z=\\sqrt{x^2+y^2}$") ;
          fTeXlabel3d(Y,-0.1,Z, "cr", "$(1,0,1)$") ;
          fTeXlabel3d(-Y,0,Z+0.1, "cb", "$(-1,0,1)$") ;
...
//          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          ...
          fCurve(new circ3d(proj,   0,0,Z, 0,Y,0, Y,0,0),
                      -90,90,OPEN)  ;
          double th1 = 44 ; double th1Rad = th1*Math.PI/180 ;
          double th2 = 46 ; double th2Rad = th2*Math.PI/180 ;
          double X1 = -Y*Math.cos(th1Rad) ; double Y1 = Y*Math.sin(th1Rad) ;
          double X2 = -Y*Math.cos(th2Rad) ; double Y2 = Y*Math.sin(th2Rad) ;
          fArrow3d(X1,Y1,Z, X2,Y2,Z) ;


          canvas.append( new fPsWrite(Blue+"\n")) ;
          fEnv("psFillColor", Blue) ;
          fLine3d(Y,0,Z, -Y,0,Z) ;
          fArrow3d(Y,0,Z, 0,0,Z) ;
          fTeXlabel3d(0, 1.05*Y, Z, "cl", "$\\cC$") ;
          fTeXlabel3d(0, -0.1*Y, Z, "cr", "$\\cL$") ;
          fTeXlabel3d(0, 0.4*Y, Z, "cc", "$\\cR$") ;
