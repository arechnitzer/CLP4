...
public class helixCone extends Template {

     static {templateClass = new helixCone() ; }
...
//          fLine3d(0,-r,0, 0,-r, z) ;
          ...
          fCurve(new helixCone3d(proj,   0,0,0, r, h),0,n*360,OPEN)  ;
          canvas.append( new fPsWrite(Red+"\n")) ;
//          fCurve(new helixCone3d(proj,   0,0,0, r, h),0,180,OPEN)  ;
//          canvas.append( new fPsWrite("[3 3] 1.5 setdash\n")) ;
//          fCurve(new helixCone3d(proj,   0,0,0, r, h),180,360,OPEN)  ;
//          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
//          fCurve(new helixCone3d(proj,   0,0,0, r, h),360,540,OPEN)  ;
          double R = 2.5;
          fEnv("psFillColor", Red) ;
//          fDot3d(0, r, 0, R, R*aspect, FILLED) ;
//          fTeXlabel3d(5,r-1, -3, "tl", "$t=0$") ;
//          fDot3d(0, -r, h*180/100, R, R*aspect, FILLED) ;
//          fTeXlabel3d(0, -r-5, h*180/100, "cr", "$t=\\frac{\\pi}{2}$") ;
//          fDot3d(0, r, h*360/100, R, R*aspect, FILLED) ;
//          fTeXlabel3d(0, r+5, h*360/100, "cl", "$t=\\pi$") ;
     }
...
class helixCone3d implements S2V {
   ...
   public helixCone3d(double[][] proj, 
     ...
     public double[] map(double t) {
          ...
          double[] out = {0,0} ;
          double z = cz + h*t/100 ;
          double x = cx+r*(z-cz)*Math.sin(t*Math.PI/180) ;
          double y = cy+r*(z-cz)*Math.cos(t*Math.PI/180) ;
          out[0] = x*proj[0][0]+y*proj[0][1]+z*proj[0][2] ;
          out[1] = x*proj[1][0]+y*proj[1][1]+z*proj[1][2] ;
          return out ;
   }
