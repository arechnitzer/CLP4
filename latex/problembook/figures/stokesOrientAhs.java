...
public class stokesOrientAhs extends Template {

     static {templateClass = new stokesOrientAhs() ; }

     public void setup() {
          filePrefix = "stokesOrientAhs" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
