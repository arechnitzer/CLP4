...
public class OE00A_2 extends Template {

     static {templateClass = new OE00A_2() ; }
...
//          fTeXlabel3d(x,y+0.1,1.3,  "cl", "$\\hn$") ;
          ...
          fArrow3d(1,0,0, 0.4,0.6,0) ;   fTeXlabel3d(0.7,0.55,0, "tl", "$\\cT_1$") ;
          fArrow3d(0,1,0, 0,0.5,0.5) ;     fTeXlabel3d(0, 0.6,0.55, "tl", "$\\cT_2$") ;
          fArrow3d(0,0,1, 0.55,0,0.45);      fTeXlabel3d(0.5,-0.05,0.55, "tr", "$\\cT_3$") ;

          double r = 0.05 ;
          fDisk3d(1,0,0, r,r*aspect, FILLED) ;
          fTeXlabel3d(1,-0.05,0.02, "br", "${\\scriptstyle (1,0,0)}$") ;
          fDisk3d(0,1,0, r,r*aspect, FILLED) ;
          fTeXlabel3d(0,1,0.05, "bl", "${\\scriptstyle (0,1,0)}$") ;
          fDisk3d(0,0,1, r,r*aspect, FILLED) ;
          fTeXlabel3d(0,0.075,1, "cl", "${\\scriptstyle (0,0,1)}$") ;
