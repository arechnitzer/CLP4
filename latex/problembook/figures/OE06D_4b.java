...
public class OE06D_4b extends Template {

     static {templateClass = new OE06D_4b() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fEnv("psFillGray", 0.8) ;
          fCurve(new circ3d(proj,   0,0,0,     r,0,0,      0,r,0), 0,90,FILLED)  ;
          ...
          fCurve(new circ3d(proj,   0,0,r*zv, r*xv,0,0, 0,r*xv,0), 0,90,FILLED)  ;
          {  double[] xlist = {0, r*xv, r*xv/Math.sqrt(2), 0} ;
             double[] ylist = {0, 0, r*xv/Math.sqrt(2), r*xv} ;
             double[] zlist = {r*zv, r*zv, r*zv, r*zv} ;
             fPolygon3d(xlist, ylist, zlist, 4, FILLED) ; }
          ...
          fTeXlabel3d(0.5*r, -9, 0.3*r, "cr", "$S$") ;
          fTeXlabel3d(0.6*r, 0.4*r, 3, "cb", "$D_b$") ;
          fTeXlabel3d(0.5*r, 0.4*r, r*zv+3, "cb", "$D_t$") ;
          fTeXlabel3d(0.5*r, 0.4*r, r*zv/2+3, "cb", "$V$") ;
