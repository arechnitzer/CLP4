...
public class OE10D_10i3 extends Template {

     static {templateClass = new OE10D_10i3() ; }

     public void setup() {
          filePrefix = "OE10D_10i3" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 3.0 ;   
          ysize = 3.0 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fEnv("psFillGray", 0.8) ;
          fDisk(XU, YU, RU, RU*aspect, FILLED) ;
          fEnv("psFillGray", 1.0) ;
          fDisk(XR, YR, RR, RR*aspect, FILLED) ;
...
//              fTeXlabel( XT+RT/S2-eps , YT+RT/S2-eps, "tr", "$T$") ;
//              fTeXlabel( XT+(0.5*RT+0.5*RS)/S2 , YT+(0.5*RT+0.5*RS)/S2, "cc", "$\\cR_1$") ;
              fArrowhead(XT+RT, YT, -90) ;
          fDisk(XR, YR, RR, RR*aspect, BOUNDARY) ;
              fTeXlabel( XR+RR/S2+eps , YR+RR/S2+eps, "bl", "$R$") ;
              fTeXlabel( 0 , -2, "cc", "$\\cR_2$") ;
