...
public class revB extends Template {

     static {templateClass = new revB() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fEnv("psFillGray", 0.9) ;
          fCurve(new circ3d(proj,   0,Y,0, 0,0,Z, Z,0,0),
                      0,90,FILLED)  ;
          { double[] xlist = {Y*proj[0][1], Y*proj[0][1]+Z*proj[0][2], Z*proj[0][0]+Y*proj[0][1]} ;
            double[] ylist = {Y*proj[1][1], Y*proj[1][1]+Z*proj[1][2], Z*proj[1][0]+Y*proj[1][1]} ;
            fPolygon(xlist, ylist, 3, FILLED) ; }



          fEnv("lineWidth", 0.5) ;
          fLine3d(0,0,0.5, 0,0,zm) ;
          fLine3d(0,YY2,0, 0,ym,0) ;
          fLine3d(0.5,0,0, xm,0,0) ;
          fTeXlabel3d(0,0,zm+0.1, "cb", "$z$") ;
          fTeXlabel3d(0,ym+0.1,0, "cl", "$y$") ;
          fTeXlabel3d(xm+0.05,-0.05,0, "tr", "$x$") ;
          fTeXlabel3d(0, 0.87*Y,0.8*Z, "cr", "$x^2\\!+\\!z^2\\!=\\!e^y$") ;
          ...
          fLine3d(0,0,0,  0.5,0,0) ;
          fLine3d(0,0,0,  0,YY2,0) ;
          fLine3d(0,0,0,   0,0,0.5) ;
          fLine3d(0,YY,0,  0,YY,ZZ) ;
          fLine3d(0,YY,0,  ZZ,YY,0) ;
          ...
          fCurve(new revXY(proj),  0,3,OPEN)  ;
          fCurve(new circ3d(proj,   0,Y,0, 0,0,Z, Z,0,0),
                      0,90,OPEN)  ;
          fCurve(new circ3d(proj,   0,0,0, 0,0,0.5, 0.5,0,0),
                      0,90,OPEN)  ;

          canvas.append( new fPsWrite(Blue+"\n")) ;
          fEnv("psFillColor", Blue) ;
//          fDisk(XX1,YY1, r, r*aspect, FILLED) ;
          fCurve(new circ3d(proj,   0,YY,0,  0,0,ZZ, ZZ,0,0),
                      0,90,OPEN)  ;
