...
public class stokesOrientAs extends Template {

     static {templateClass = new stokesOrientAs() ; }

     public void setup() {
          filePrefix = "stokesOrientAs" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
