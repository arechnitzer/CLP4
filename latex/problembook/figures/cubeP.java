...
public class cubeP extends Template {

     static {templateClass = new cubeP() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(X3,Y3+2,Z3,  "cl", "$(0,1,1)$") ;
          fTeXlabel3d(X2,Y2+2,0,  "lt", "$(1,1,0)$") ;
          fTeXlabel3d(X2/2,Y2/2,0,  "cc", "$F$") ;
