...
public class cylOffset extends Template {

     static {templateClass = new cylOffset() ; }
...
//          double x1 = 0.5*Math.sin(Math.PI*(1+al/180)) ;
          ...
          fLine(-30,0,xmax,0) ;
          fLine(-30,0,-30,ymax) ;
          fLine(-30,0, xmax*x0-30, xmax*x1) ;
          fLine(0,0, x*x0+y,x*x1) ;
          fLine(0,0, 0.5*xmax*x0, 0.5*xmax*x1) ;
          ...
          fTeXlabel(2,2, "cb", "$(0,1,0)$") ;
          fTeXlabel(xmax+5,0, "lc", "$y$") ;
          fTeXlabel(-30,ymax+5, "bc", "$z$") ;
          fTeXlabel(xmax*x0-30-1, xmax*x1-1, "tr", "$x$") ;
