...
public class OE98D_1 extends Template {

     static {templateClass = new OE98D_1() ; }
...
//  General orthogonal projection.  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fEnv("lineWidth", 1.5) ;
          fCurve(new spiral3d(proj),   0,Math.PI,OPEN)  ;
...
class spiral3d implements S2V {

     double[][] proj ;

     public spiral3d(double[][] proj) {
          this.proj = proj ;  
     }
