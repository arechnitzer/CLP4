...
public class OE07A_4b extends Template {

     static {templateClass = new OE07A_4b() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fCurve(new circ3d(proj,   0,0,Z, 0,Y,0, Y,0,0),
                      0,90,FILLED)  ;
          { double[] xlist = {Z*proj[0][2], Y*proj[0][1]+Z*proj[0][2], 0.7*Y*proj[0][1]+0.7*Y*proj[0][0]+Z*proj[0][2], Y*proj[0][0]+Z*proj[0][2]} ;
            double[] ylist = {Z*proj[1][2], Y*proj[1][1]+Z*proj[1][2], 0.7*Y*proj[1][1]+0.7*Y*proj[1][0]+Z*proj[1][2], Y*proj[1][0]+Z*proj[1][2]} ;
          ...
          fTeXlabel3d(0, 0.75*Y,0.5*Z, "cl", "$z=x^2+y^2=r^2$") ;
          fTeXlabel3d(0, 0.5*Y,Z+0.1, "cb", "$z=4$") ;
...
//          String LBlue = "0 0.5 1 setrgbcolor  " ;
          ...
          fCurve(new revYZ(proj),  0,2,OPEN)  ;
          fCurve(new revXZ(proj),  0,2,OPEN)  ;
          fCurve(new circ3d(proj,   0,0,Z, 0,Y,0, Y,0,0),
                      0,90,OPEN)  ;
          ...
          fEnv("psFillColor", LBlue) ;
//          fEnv("psFillColor", Green) ;
...
//          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          fCurve(new circ3d(proj,   0,0,ZZ, 0,YY,0, YY,0,0),
                      0,90,FILLED)  ;
          { double[] xlist = {ZZ*proj[0][2], YY*proj[0][1]+ZZ*proj[0][2], 0.7*YY*proj[0][1]+0.7*YY*proj[0][0]+ZZ*proj[0][2], YY*proj[0][0]+ZZ*proj[0][2]} ;
            double[] ylist = {ZZ*proj[1][2], YY*proj[1][1]+ZZ*proj[1][2], 0.7*YY*proj[1][1]+0.7*YY*proj[1][0]+ZZ*proj[1][2], YY*proj[1][0]+ZZ*proj[1][2]} ;
            fPolygon(xlist, ylist, 4, FILLED) ; }
