...
public class stokesOrientBs extends Template {

     static {templateClass = new stokesOrientBs() ; }

     public void setup() {
          filePrefix = "stokesOrientBs" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
...
//          String Black = "0 0 0 1 setcmykcolor  " ;
          ...
          fTeXlabel((2*R-RR)*Math.cos(th), -(2*R-RR)*Math.sin(th), "rt", "$\\hn$") ;
          ...
          fArrow(x1,y1, x2,y2) ;
          fTeXlabel(x1, y1+0.1, "rb", "$\\partial S$") ;
     }
}
