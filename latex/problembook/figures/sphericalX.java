...
public class sphericalX extends Template {

     static {templateClass = new sphericalX() ; }
...
//          fTeXlabel3d(P[0], P[1]+2.0, 0, "cl", "$(x,y,0)$") ;
          ...
          fLine3d(P[0], P[1], P[2], P[0], 0, 0) ;
          fTeXlabel3d(P[0], P[1]/3.0, P[2]/3.0+2, "tl", "$\\sqrt{y^2+z^2}$") ;
//          fLine3d(P[0], P[1], P[2], P[0], P[1], 0) ;
//          fLine3d(0,0,0, P[0],P[1], 0) ;
//          fLine3d(P[0],0,0, P[0],P[1], 0) ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          double R = 12 ; double RR = Math.sqrt(P[1]*P[1]+P[2]*P[2]) ;
          double YY = R*P[1]/RR ; 
          double ZZ = R*P[2]/RR ; 
          fCurve(new circ3d(proj,0,0,0, R,0,0,  0,1.2*YY,1.2*ZZ), 
                                       0, 70, OPEN)  ;
//          fCurve(new circ3d(proj,0,0,0, 0,0,1.2*R,   
//                   1.2*R*Math.cos(th),1.2*R*Math.sin(th),0), 
//                                       0, phi*180/Math.PI, OPEN)  ;
//          fTeXlabel3d(0.56*P[0], 0.16*P[1], 0, "cl", "$\\theta$") ;
//          fTeXlabel3d(0.56*P[0], 0.28*P[1], 0.43*P[2], "bl", "$\\varphi$") ;
