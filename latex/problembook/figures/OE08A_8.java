...
public class OE08A_8 extends Template {

     static {templateClass = new OE08A_8() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          double X2 = 0 ; double Y2 = 1 ; double Z2 = 1 ;
          double X3 = 0 ; double Y3 = 1 ; double Z3 = 2 ;
          double X4 = 0 ; double Y4 = 2 ; double Z4 = 0 ;
          double X5 = 2 ; double Y5 = 2 ; double Z5 = 0 ;
          ...
          double dX5 = X1-X5 ; double dY5 = Y1-Y5 ; double dZ5 = Z1-Z5 ;
          ...
          {  double[] xlist = {X1, X4, X5} ;
             double[] ylist = {Y1, Y4, Y5} ;
             double[] zlist = {Z1, Z4, Z5} ;
...
//          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          ...
          {  double[] xlist = {X1, X2, X3, X4, X5} ;
             double[] ylist = {Y1, Y2, Y3, Y4, Y5} ;
             double[] zlist = {Z1, Z2, Z3, Z4, Z5} ;
             fPolygon3d(xlist, ylist, zlist, 5, CLOSED) ; }
...
//          fTeXlabel3d(XC+L*1.05,YC+L*1.05,ZC+L*1.05,  "lb", "$\\hn$") ;
          ...
          fTeXlabel3d(X1,Y1-0.1,Z1,  "rc", "$(0,0,0)$") ;
          fDisk3d(X2,Y2,Z2, r,r, FILLED) ;
          fTeXlabel3d(X2,Y2-0.05,Z2,  "br", "$(0,1,1)$") ;
          fDisk3d(X3,Y3,Z3, r,r, FILLED) ;
          fTeXlabel3d(X3,Y3+0.05,Z3,  "lb", "$(0,1,2)$") ;
          fDisk3d(X4,Y4,Z4, r,r, FILLED) ;
          fTeXlabel3d(X4,Y4+0.05,Z4+0.05,  "lb", "$(0,2,0)$") ;
          fDisk3d(X5,Y5,Z5, r,r, FILLED) ;
          fTeXlabel3d(X5,Y5,Z5-0.05,  "tr", "$(2,2,0)$") ;


          fTeXlabel3d(0.7,1.5,0,  "cc", "$T$") ;
          fTeXlabel3d(0,1.2,0.5,  "cc", "$Q$") ;
