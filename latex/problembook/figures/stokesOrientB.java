...
public class stokesOrientB extends Template {

     static {templateClass = new stokesOrientB() ; }

     public void setup() {
          filePrefix = "stokesOrientB" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
