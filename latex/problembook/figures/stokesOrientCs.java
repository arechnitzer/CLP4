...
public class stokesOrientCs extends Template {

     static {templateClass = new stokesOrientCs() ; }

     public void setup() {
          filePrefix = "stokesOrientCs" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
