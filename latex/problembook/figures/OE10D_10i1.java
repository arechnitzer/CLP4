...
public class OE10D_10i1 extends Template {

     static {templateClass = new OE10D_10i1() ; }

     public void setup() {
          filePrefix = "OE10D_10i1" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 3.0 ;   
          ysize = 3.0 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fEnv("psFillGray", 0.8) ;
          fDisk(XS, YS, RS, RS*aspect, FILLED) ;
          fEnv("psFillGray", 1.0) ;
          fDisk(XT, YT, RT, RT*aspect, FILLED) ;
