...
public class parabolicBowl extends Template {

     static {templateClass = new parabolicBowl() ; }
...
////  General orthogonal projection.  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fCurve(new circ3d(proj, 0,Y,0, R,0,0, 0,0,R) , 0, 90,FILLED)  ;
          {  double[] xlist = {0, 0, R} ;
             double[] ylist = {Y, Y, Y} ;
             double[] zlist = {0, R, 0} ;
          ...
          fCurve(new paraX3d(proj, CY) , 0, Y,OPEN)  ;
          fCurve(new paraZ3d(proj, CY) , 0, Y,OPEN)  ;
          fCurve(new circ3d(proj, 0,Y,0, R,0,0, 0,0,R) , 0, 90,OPEN)  ;
          fLine3d(0,Y,0, 0,Y,R) ;
          fLine3d(0,Y,0, R,Y,0) ;
//          fTeXlabel3d(1.8,1.5,0, "tr", "$2y=x^2+z^2$") ;
...
class paraX3d implements S2V {
   ...
   public paraX3d(double[][] proj, double cy) {
        this.proj = proj ;
        this.cy = cy ;
   }
...
class paraZ3d implements S2V {
   ...
   public paraZ3d(double[][] proj, double cy) {
        this.proj = proj ;
        this.cy = cy ;
   }
