...
public class divThmB extends Template {

     static {templateClass = new divThmB() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
         ...
         {  double[] xlist = {0, 0, 0.7*Y, Y} ;
          ...
          fTeXlabel3d(0, 0.5*Y,0.85*Z, "cl", "$z=1-x^2-y^2$") ;
          fTeXlabel3d(1.15*Y, 0.7*Y,0, "cl", "$x^2+y^2=1$") ;
          fTeXlabel3d(0.4*Y, 0.4*Y,0, "cc", "$D$") ;
          fTeXlabel3d(0, 0.9*Y,0.45*Z, "cc", "$S$") ;
