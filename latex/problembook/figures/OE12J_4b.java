...
public class OE12J_4b extends Template {

     static {templateClass = new OE12J_4b() ; }
...
//          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          ...
          fTeXlabel3d(bx,by+0.02,bz+0.02, "tr", "$\\hn$") ;
          fArrow3d(cx,cy,cz, dx,dy,dz) ;
          fTeXlabel3d(dx,dy+0.05,dz+0.05, "tr", "$\\hn$") ;
          ...
          fEnv("lineWidth", 1.0) ;
          fArrow3d(0,3.5,3, 0,3.5,3.75) ;
          fTeXlabel3d(0,3.5+0.05,3.75+0.02, "bl", "$\\hk$") ;
          fTeXlabel3d(0,0,3, "cc", "$D$") ;
          fTeXlabel3d(0,-3.3,1.5, "cr", "$S$") ;
          fTeXlabel3d(0,0,1.2, "ct", "$S$") ;
          fTeXlabel3d(0,-1.5,1.5, "cc", "$V$") ;
