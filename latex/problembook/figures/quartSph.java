...
public class quartSph extends Template {

     static {templateClass = new quartSph() ; }
...
//          fTeXlabel3d(0, 0.75*R ,0.8*R, "cl", "${\\scriptstyle x^2+y^2+z^2=a^2}$") ;
          fTeXlabel3d(0, 0.75*R ,0.8*R, "cl", "$x^2+y^2+z^2=a^2$") ;
