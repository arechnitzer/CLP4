...
public class parabolicBowlB extends Template {

     static {templateClass = new parabolicBowlB() ; }
...
////  General orthogonal projection.  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fLine3d(R/Math.sqrt(2),R/Math.sqrt(2),Z, 0,0,Z) ;
          fLine3d(R/Math.sqrt(2),R/Math.sqrt(2),0, 0,0,0) ;
          fLine3d(R/Math.sqrt(2),R/Math.sqrt(2),0, R/Math.sqrt(2),R/Math.sqrt(2),Z) ;
          fTeXlabel3d(R/Math.sqrt(2),R/Math.sqrt(2)+0.05,0, "bl", "$x=y$") ;
          ...
          fCurve(new paraXY3d(proj) , 0, Math.sqrt(Z/2.0),OPEN)  ;
          ...
          fEnv("lineWidth", 1.0) ;
          fArrow3d(x,y,z, x+dx,y+dy, z+dz) ;
          fTeXlabel3d(x+dx,y+dy-0.07, z+dz, "cr", "$\\scriptstyle \\hat\\vT$") ;
          L = 0.6/Math.sqrt(1+8*x*x) ;
          dx = -2*x*L ; dy = -2*x*L ; dz = 1*L ;
          fArrow3d(x,y,z, x+dx,y+dy, z+dz) ;
          fTeXlabel3d(x+dx,y+dy, z+dz+0.05, "bl", "$\\scriptstyle \\hat\\vN$") ;
          L = 0.6/Math.sqrt(2) ;
          dx = 1*L ; dy = -1*L ; dz = 0 ;
          fArrow3d(x,y,z, x+dx,y+dy, z+dz) ;
          fTeXlabel3d(x+dx,y+dy, z+dz+0.1, "bl", "$\\scriptstyle \\hat\\vB$") ;
