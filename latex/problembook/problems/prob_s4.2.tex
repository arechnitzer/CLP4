...
cylinder $x^2 + y^2 = 1$ and above the $xy$-plane. Find the flux of the vector field
\begin{equation*}
...
V=\Set{(x,y,z)}{0\le z\le 1-\big(x^2+y^2\big)^2}\hskip0.5in\raisebox{-37pt}[30pt][25pt]
                         {\smash{\includegraphics{OE08D_10.pdf}}}
\end{equation*}
...
\hskip1.0in
\raisebox{-45pt}[65pt][30pt]{\includegraphics[scale=0.8]{OE07A_4.pdf}}
\end{equation*}
So the divergence theorem gives
\begin{align*}
\dblInt_S \vF \cdot\hn\,\dee{S}
