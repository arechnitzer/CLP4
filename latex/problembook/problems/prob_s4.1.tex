...
\begin{solution} 
(a)
We saw in Theorem  \eref{CLP317}{thm:screenVector} in the CLP-4 text that 
in order for it to be possible to express $\vF$ in the form $\nabla\times\vG$,
$\vF$ must pass the screening test
\begin{equation*}
\nabla\cdot \vF=\nabla\cdot \nabla\times\vG=0
\end{equation*}
So we must have
