...
of flow is radially outward and
\begin{align*}
   \frac{x\hi+y\hj}{\sqrt{x^2+y^2}}
\end{align*}
is a radially outward unit vector, we have
\begin{align*}
   \vv=\frac{m}{r}\  \frac{x\hi+y\hj}{\sqrt{x^2+y^2}}
     =m\frac{x\hi+y\hj}{x^2+y^2}
\end{align*}
$\varphi(x,y)$ is a potential for this vector field if and only if
\begin{align*}
