...
=\det\left|\begin{matrix}
           ...
           \end{matrix}\right|
\end{align*}
is normal (i.e. perpendicular) to the surface at $(x_0,y_0,z_0)$, if $\vn\ne \vZero$.


\item
Let $(x_0,y_0,z_0)=f(x_0,y_0)$ be a point on the surface $z=f(x,y)$. Then, 
\begin{align*}
...
vectors to $S$ at $\vr(u_0,v_0)$ and the cross product
$\frac{\partial\vr}{\partial u}(u_0\,,\,v_0)\times
              \frac{\partial\vr}{\partial v}(u_0\,,\,v_0)$
is perpendicular to $S$ at $\vr(u_0,v_0)$. We have found
...
\end{equation*}
When we define our integral by taking the limit $n\rightarrow \infty$ of 
...
\raisebox{-20pt}[20pt][15pt]{\includegraphics{canTopView.pdf}}
\\
