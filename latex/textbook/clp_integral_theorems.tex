...
\begin{efig}
\begin{center}
    \includegraphics{cone.pdf}\qquad\qquad
...
the vector $\ha{k}\rightarrow e^{0.4\cV}\ha{k}$. The darkly shaded parallelepiped has edges $e^{0.4\cV}\ha{k}$.
\item
...
(as in the darkly shaded parallelepiped of the left hand figure). 
