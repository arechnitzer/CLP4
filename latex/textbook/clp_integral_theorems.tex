...
\vnabla\times\vB -\frac{1}{c}\frac{\partial\vE}{\partial t}&=\frac{4\pi}{c}\vJ 
\end{align*}
...
and ensures that the right hand actually does not depend on $z$.
...
to be the direction of the gradient vector $\vnabla f(\vr_0)$.
In conclusion
\begin{impeqn}\label{eq:gradInterp}
\begin{align*}
\text{the gradient vector }\vnabla f(\vr_0) &=
    \frac{\partial f}{\partial x}(\vr_0)\,\hi
          +\frac{\partial f}{\partial y}(\vr_0)\,\hj
          +\frac{\partial f}{\partial z}(\vr_0)\,\hk \\[0.05in]
\quad\text{has direction}&=\left\{
       \parbox[c]{6.0cm}{direction of maximum rate
                           of change of $f$ at $\vr_0$}
                           \right. \\[0.1in]
\text{and has magnitude}&=\left\{
...
\item[$\circ$] is oriented in the standard way with respect to $\hn$.
   ...
   same direction as  $\hn$ and with your left arm pointing towards $\vr_0$.
   Then you are facing in the positive direction for $C_\veps$.
\end{itemize}
\begin{nfig}
\begin{center}
...
\begin{itemize}\itemsep1pt \parskip0pt \parsep0pt %\itemindent-15p
\item
Let $a>0$ and denote by $C_a$ the counterclockwise oriented circle in 
