...
public class parCurveDeriv extends Template {

     static {templateClass = new parCurveDeriv() ; }

     public void setup() {
          filePrefix = "parCurveDeriv" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2 ;   
          ysize = 1.3 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fArrow(x1,y1, x2,y2) ;
          fTeXlabel( (x1+x2)*0.5-0.3, (y1+y2)*0.5+0.03, "bl", "$\\vr(t+h)-\\vr(t)\\approx\\vr'(t)\\,h$") ;
