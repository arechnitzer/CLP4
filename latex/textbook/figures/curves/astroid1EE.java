...
public class astroid1EE extends Template {

     static {templateClass = new astroid1EE() ; }

     public void setup() {
          filePrefix = "astroid1EE" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2 ;      // in inches
          ysize = 2 ;   // in inches. 
