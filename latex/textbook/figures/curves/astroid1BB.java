...
public class astroid1BB extends Template {

     static {templateClass = new astroid1BB() ; }

     public void setup() {
          filePrefix = "astroid1BB" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2 ;      // in inches
          ysize = 2 ;   // in inches. 
