...
public class astroid1CC extends Template {

     static {templateClass = new astroid1CC() ; }

     public void setup() {
          filePrefix = "astroid1CC" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2 ;      // in inches
          ysize = 2 ;   // in inches. 
