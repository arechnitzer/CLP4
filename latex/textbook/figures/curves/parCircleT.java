...
public class parCircleT extends Template {

     static {templateClass = new parCircleT() ; }

     public void setup() {
          filePrefix = "parCircleT" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 1.8 ;   
          ysize = 1.8 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fArrow(x,y, x+f*xT,y+f*yT) ;
          fTeXlabel( x+f*xT, y+f*yT, "bl", "$\\hat\\vT(\\theta)$") ;
