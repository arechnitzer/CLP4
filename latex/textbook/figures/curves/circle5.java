...
public class circle5 extends Template {

     static {templateClass = new circle5() ; }
...
////  General orthogonal projection.  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fEnv("lineWidth", 1.0) ;
          fCurve(new circ3d(proj, cx,cy,cz, 2*r,-r,-r, 0,s6*r/s2,-s6*r/s2),
                 0,360,OPEN)  ;
          canvas.append( new fPsWrite(Black+"\n")) ;

          fEnv("lineWidth", 0.5) ;
          fLine3d(3*r, 0, 0,  0, 3*r, 0) ;
          fLine3d(0, 3*r, 0,  0, 0, 3*r) ;
          fLine3d(3*r, 0, 0,  0, 0, 3*r) ;
//          fArrow3d(cx, cy, cz,  cx+2*r/s6, cy-r/s6, cz-r/s6) ;
//          fArrow3d(cx, cy, cz,  cx, cy+r/s2, cz-r/s2) ;
//
//          fTeXlabel3d(cx+r, cy-5, cz, "rc", "$\\hi'$") ;
//          fTeXlabel3d(cx, cy+r/s2+2, cz+r/s2-4, "lc", "$\\hj'$") ;
