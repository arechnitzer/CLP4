...
public class reparCircleA extends Template {

     static {templateClass = new reparCircleA() ; }

     public void setup() {
          filePrefix = "reparCircleA" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.6*0.7 ;   
          ysize = 1.5*0.7 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(x+0.05, y+0.03, "bl", "$\\big(r\\cos\\theta\\,,\\,r\\sin\\theta\\big)$") ;
