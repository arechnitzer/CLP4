...
public class curvatureSignA extends Template {

     static {templateClass = new curvatureSignA() ; }

     public void setup() {
          filePrefix = "curvatureSignA" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.2 ;   
          ysize = 2.2 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          double alDeg = -67.5 ; double al = alDeg*Math.PI/180 ;
          ...
          double xL = rho/2 +0.2 ; double yL = -rho-0.15 ;
