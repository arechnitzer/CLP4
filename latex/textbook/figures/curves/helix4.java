...
public class helix4 extends Template {

     static {templateClass = new helix4() ; }
...
//                                {             -0.5,             -0.5, 1}   } ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fCurve(new helix3d(proj,   0,0,0, r, h),0,180,OPEN)  ;
          canvas.append( new fPsWrite("[3 3] 1.5 setdash\n")) ;
          fCurve(new helix3d(proj,   0,0,0, r, h),180,360,OPEN)  ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          fCurve(new helix3d(proj,   0,0,0, r, h),360,540,OPEN)  ;
          double R = 2.5;
...
class helix3d implements S2V {
   ...
   public helix3d(double[][] proj, 
     ...
     public double[] map(double t) {
          ...
          double[] out = {0,0} ;
          double x = cx+r*Math.sin(t*Math.PI/180) ;
          double y = cy+r*Math.cos(t*Math.PI/180) ;
          double z = cz + h*t/100 ;
          out[0] = x*proj[0][0]+y*proj[0][1]+z*proj[0][2] ;
          out[1] = x*proj[1][0]+y*proj[1][1]+z*proj[1][2] ;
          return out ;
