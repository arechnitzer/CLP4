...
public class astroid3a extends Template {

     static {templateClass = new astroid3a() ; }

     public void setup() {
          filePrefix = "astroid3a" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2 ;      // in inches
          ysize = 2 ;   // in inches. 
