...
public class astroid1AA extends Template {

     static {templateClass = new astroid1AA() ; }

     public void setup() {
          filePrefix = "astroid1AA" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2 ;      // in inches
          ysize = 2 ;   // in inches. 
