...
public class helix6 extends Template {

     static {templateClass = new helix6() ; }
...
//          fTeXlabel3d(0, r+4, h*450/100, "cl", "$t=\\frac{5\\pi}{2}$") ;
          ...
          double s = 3.5 ;
          fCurve(new helix3d(proj,   0,0,0, -s*h*h/r, h),90,270,OPEN)  ;
          canvas.append( new fPsWrite("[3 3] 1.5 setdash\n")) ;
          fCurve(new helix3d(proj,   0,0,0, -s*h*h/r, h), 0, 90,OPEN)  ;
          fCurve(new helix3d(proj,   0,0,0, -s*h*h/r, h),270,450,OPEN)  ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          fCurve(new helix3d(proj,   0,0,0, -s*h*h/r, h),450,630,OPEN)  ;
