...
public class circle3 extends Template {

     static {templateClass = new circle3() ; }
...
////  General orthogonal projection.  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fEnv("lineWidth", 1.0) ;
          fCurve(new circ3d(proj,   cx,cy,cz, rx,0,0, 0,ry,h1), 0,360,OPEN)  ;
          canvas.append( new fPsWrite(Black+"\n")) ;

          fArrow3d(cx, cy, cz,  cx, cy+ry, cz+h1) ;
          fArrow3d(cx, cy, cz,  cx, cy-0.5*h1, cz+0.5*ry) ;
          fArrow3d(cx, cy, cz,  cx+rx, cy, cz) ;

          fTeXlabel3d(cx+rx, cy, cz, "tl", "$\\rho\\hi'$") ;
          fTeXlabel3d(cx, cy+ry, cz+h1, "tl", "$\\rho\\hj'$") ;
          fTeXlabel3d(cx, cy-0.5*h1+3, cz+0.5*ry, "bl", "$\\hk'$") ;

          fTeXlabel3d(cx, cy-4, cz, "cr","$\\vc$") ;
