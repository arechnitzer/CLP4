...
public class circle2 extends Template {

     static {templateClass = new circle2() ; }
...
////  General orthogonal projection.  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          double cx, cy, cz, h1, h2, rx, ry, rz ;
          cx = -5 ;
          cy = 20 ;
          cz = 20 ;
          rx = 40 ;
          ...
          fEnv("lineWidth", 1.0) ;
          fCurve(new circ3d(proj,   cx,cy,cz, rx,0,0, 0,ry,0), 0,360,OPEN)  ;
          canvas.append( new fPsWrite(Black+"\n")) ;

          fArrow3d(cx, cy, cz,  cx+rx, cy, cz) ;
          fArrow3d(cx, cy, cz,  cx, cy+ry, cz) ;
          fArrow3d(cx, cy, cz,  cx, cy, cz+rz) ;
          fTeXlabel3d(cx+rx+1, cy+1, cz, "tl", "$\\rho\\hi$") ;
          fTeXlabel3d(cx, cy+ry+1, cz-1, "tl", "$\\rho\\hj$") ;
          fTeXlabel3d(cx, cy+2, cz+rz, "bl", "$\\hk$") ;
          fTeXlabel3d(cx, cy-3, cz, "br", "$\\vc$") ;
