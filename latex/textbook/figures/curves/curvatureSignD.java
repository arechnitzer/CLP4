...
public class curvatureSignD extends Template {

     static {templateClass = new curvatureSignD() ; }

     public void setup() {
          filePrefix = "curvatureSignD" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.2 ;   
          ysize = 2.2 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          double alDeg =  90+22.5 ; double al = alDeg*Math.PI/180 ;
