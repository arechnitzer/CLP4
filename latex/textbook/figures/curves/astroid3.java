...
public class astroid3 extends Template {

     static {templateClass = new astroid3() ; }

     public void setup() {
          filePrefix = "astroid3" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 3 ;      // in inches
          ysize = 3 ;   // in inches. 
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(-2, -2, "tr", "$O$") ;
          fTeXlabel(px, py+5, "bc", "$P$") ;
          fTeXlabel(12, 12, "bl", "$\\theta$") ;
          fTeXlabel(cx-7, cy, "tr", "$\\phi$") ;
