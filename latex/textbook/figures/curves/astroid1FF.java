...
public class astroid1FF extends Template {

     static {templateClass = new astroid1FF() ; }

     public void setup() {
          filePrefix = "astroid1FF" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2 ;      // in inches
          ysize = 2 ;   // in inches. 
