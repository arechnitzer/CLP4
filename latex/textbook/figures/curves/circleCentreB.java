...
public class circleCentreB extends Template {

     static {templateClass = new circleCentreB() ; }

     public void setup() {
          filePrefix = "circleCentreB" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2*0.85 ;   
          ysize = 2*0.85 ;   
