...
public class faraday extends Template {

     static {templateClass = new faraday() ; }
...
//          fTeXlabel3d(xm,-1,-1, "tr", "$x$") ;
          ...
          fEnv("lineWidth", 1.0) ;
          fEnv("psFillGray", 0.9) ;
          fCurve(new circ3d(proj,   cx,cy,cz, r,0,0, 0,r,0), 0,360,FILLED)  ;
          fCurve(new circ3d(proj,   cx,cy,cz, r,0,0, 0,r,0), 0,360,CLOSED)  ;



          fEnv("headHalfWidth", 2.0*1.2) ;
          fEnv("headLength", 6.0*1.2) ;
          fArrow3d(cx-10, cy, cz, cx-10, cy, cz+30) ;
          fArrow3d(cx+10, cy, cz, cx+10, cy, cz+30) ;
          fArrow3d(cx, cy-15, cz, cx, cy-15, cz+30) ;
          fArrow3d(cx, cy+15, cz, cx, cy+15, cz+30) ;
          fTeXlabel3d(cx,cy,cz+33, "bc", "$\\vB$") ;
          fTeXlabel3d(cx+14,cy+10,cz, "bc", "$S$") ;
          
          double th = 20*Math.PI/180.0 ;
          fTeXlabel3d(cx+r*Math.cos(th), cy+r*Math.sin(th), cz-2, "tc", "$C$") ;
