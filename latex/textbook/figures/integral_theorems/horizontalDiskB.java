...
public class horizontalDiskB extends Template {

     static {templateClass = new horizontalDiskB() ; }
...
////  General orthogonal projection.  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fEnv("lineWidth", 1.0) ;
          fEnv("psFillGray", 0.8) ;
          fCurve(new circ3d(proj,   cx,cy,H, rx,0,0, 0,ry,0), 0,360,FILLED)  ;
          canvas.append( new fPsWrite(Red+"\n")) ;
          fCurve(new circ3d(proj,   cx,cy,H, rx,0,0, 0,ry,0), th1,th2,OPEN)  ;
//          fCurve(new circ3d(proj,   cx,cy,H, 0,ry,0, 0,0,cz), 0,180,OPEN)  ;
//          canvas.append( new fPsWrite("[3 3] 1.4 setdash\n")) ;
          fCurve(new circ3d(proj,   cx,cy,H, rx,0,0, 0,ry,0), th2,th1+360,OPEN)  ;
//          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          ...
          fArrow3d(x3a,y3a,H,  x3b,y3b,H) ;
          fEnv("useColorPs", "false") ;
          fArrow3d(cx+15, 1.3*cy,H, cx+15, 1.3*cy, H+25) ;
          fTeXlabel3d(cx+15,1.3*cy+2,H+25, "lc", "$\\hn$") ;

          double HH = 10.2;
          fEnv("lineWidth", 0.5) ;
          fLine3d(cx,cy,0, cx,cy,HH) ;
          fLine3d(cx,cy,H, cx,cy,zm) ;
          canvas.append( new fPsWrite("[2 2] 1 setdash\n")) ;
          fLine3d(cx,cy,H, cx,cy,HH) ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          ...
          fTeXlabel3d(cx,cy-10,H, "cc", "$S$") ;
          fTeXlabel3d(x3b+10,y3b-2,H, "tl", "$C$") ;
