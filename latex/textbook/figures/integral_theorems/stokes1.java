...
public class stokes1 extends Template {

     static {templateClass = new stokes1() ; }
...
//          fEnv("psFillGray", 0.4) ;
          ...
          double Xy  = -l*rx*h1 ;
          double Xz  = l*rx*ry ;
          fArrow3d(cx, cy+dy, cz+dz1,  cx+Xx, cy+dy+Xy, cz+dz1+Xz) ;
          fTeXlabel3d(cx+Xx, cy+dy+Xy+1, cz+dz1+Xz, "bl", "$\\hn$") ;
