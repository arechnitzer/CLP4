...
public class circle4a extends Template {

     static {templateClass = new circle4a() ; }
...
////  General orthogonal projection.  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fDisk3d(cx+2*rx,cy,cz, 1.6,1.6, FILLED) ;
          fTeXlabel3d(cx+2*rx,cy-1,cz, "tr", "$(2,0,0)$") ;
          ...
          fArrow3d(cx, cy, cz,  cx, cy-ry/s2, cz+ry/s2) ;
          fArrow3d(cx, cy, cz,  cx+rx*1.2, cy, cz) ;

          fTeXlabel3d(cx+rx*1.2, cy-5, cz, "rc", "$\\hi'$") ;
          fTeXlabel3d(cx, cy+ry/s2+2, cz+ry/s2-4, "lc", "$\\hj'$") ;
          fTeXlabel3d(cx, cy-ry/s2-2, cz+ry/s2, "br", "$\\hk'$") ;
