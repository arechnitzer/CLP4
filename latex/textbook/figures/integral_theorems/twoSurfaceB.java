...
public class twoSurfaceB extends Template {

     static {templateClass = new twoSurfaceB() ; }
...
//          fLine3d(0,0,0, 0,8,0) ;
//          fLine3d(0,ym-13,0, 0,ym,0) ;
//          canvas.append( new fPsWrite("[3 3] 1.4 setdash\n")) ;
//          fLine3d(0,8,0, 0,ym-13,0) ;
...
//          fTeXlabel3d(xm,-1,-1, "tr", "$x$") ;
          ...
          fArrow3d(cx-10, 1.3*cy,-10, cx-10, 1.3*cy, -25) ;
          canvas.append( new fPsWrite("[3 3] 1.4 setdash\n")) ;
          fLine3d(cx-10, 1.3*cy,0, cx-10, 1.3*cy,-7) ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          fTeXlabel3d(cx-10,1.3*cy-2,-23, "cr", "$\\hN$") ;
          fArrow3d(cx,cy,cz,   cx, cy, cz+25) ;
          fTeXlabel3d(cx,cy-2,cz+25, "cr", "$\\hN$") ;


          fTeXlabel3d(cx,1.5*cy,cz-8, "bc", "$S_2$") ;
          fTeXlabel3d(cx,cy,0, "cc", "$S_1$") ;
