...
public class stokes6a extends Template {

     static {templateClass = new stokes6a() ; }
...
//          fTeXlabel3d(xm,-1,-1, "tr", "$x$") ;
          ...
          double ax, ay, az, bx, by, bz, cy, cz ;
          ax = 1 ;
          ay = Math.sqrt(2) ;
          az = Math.sqrt(3) ;
          bz = 2.3 ;
          ...
          fEnv("lineWidth", 1.3) ;
          fCurve(new circ3d(proj, 0,0,0, ax,0,0, 0,ay,0), -90,90,OPEN)  ;
          canvas.append( new fPsWrite("[3 3] 1.5 setdash\n")) ;
          fCurve(new circ3d(proj, 0,0,0, ax,0,0, 0,ay,0), 90,270,OPEN)  ;
          ...
          fCurve(new para3d(proj, 8) , -by, -cy,OPEN)  ;
          fCurve(new para3d(proj, 8) ,  cy, by,OPEN)  ;
//          canvas.append( new fPsWrite("[3 3] 1.5 setdash\n")) ;
          fCurve(new para3d(proj, 8) , -cy, cy,OPEN)  ;
//          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
