...
public class openUnion extends Template {

     static {templateClass = new openUnion() ; }

     public void setup() {
          filePrefix="openUnion";//used as the prefix for the ps and lbl files
          outputPsFile = true ;
          outputLblFile = true ;
