...
public class lSphere extends Template {

     static {templateClass = new lSphere() ; }
...
//          fEnv("lineWidth", 1.2) ;
          ...
          fCurve(new circ3d(al, 0.5,   0,0,0, r1,0,0, 0,r1,0),
                 0,360,CLOSED)  ;
          fTeXlabel3d(0,-r1/1.5-4,-r1/1.5-4, "tr", "$\\cD_2$") ;
          canvas.append( new fPsWrite(Blue+"\n")) ;
          fLine3d(0,0,-r11, 0,0,r11) ;
