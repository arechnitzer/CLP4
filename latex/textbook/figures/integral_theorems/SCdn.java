...
public class SCdn extends Template {

     static {templateClass = new SCdn() ; }

     public void setup() {
          filePrefix = "SCdn" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0 ;      // in inches
          ysize = 2.0 ;   // in inches. 
