...
public class stokes7 extends Template {

     static {templateClass = new stokes7() ; }
...
//          fTeXlabel3d(xm,-1,-1, "tr", "$x$") ;
          ...
          fTeXlabel3d(0, -0.05, 1, "br", "$z=(1-x^2-y^2)(1-y^3)e^y\\cos x$") ;
          fTeXlabel3d(1, 0, -0.05, "tc", "$x^2+y^2=1,\\ z=0$") ;
