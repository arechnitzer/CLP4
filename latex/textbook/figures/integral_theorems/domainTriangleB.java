...
public class domainTriangleB extends Template {

     static {templateClass = new domainTriangleB() ; }

     public void setup() {
          filePrefix = "domainTriangleB" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0 ;    
          ysize = 2.0 ;  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fLine(0,c,b,0) ;
//          fArrow(b,0, b/2, c/2) ;
          fTeXlabel(b/2+2,c/2, "bl", "$z=6-3x-2y$") ;
          fLine(a*x0,a*x1,b,0) ;
//          fArrow(a*x0,a*x1, b/2+a*x0/2, a*x1/2) ;
          fTeXlabel(b/2+a*x0/2, a*x1/2-3, "tl", "$3x+2y=6$") ;
          fTeXlabel(b/2+a*x0/2+8, a*x1/2-16, "tl", "$z=0$") ;
          fTeXlabel(b/2+a*x0/2-8, a*x1/2+10, "tl", "$R$") ;
          fLine(a*x0,a*x1,0,c) ;
//          fArrow(0,c, a*x0/2, a*x1/2+c/2) ;
          fTeXlabel(a*x0/2-3, a*x1/2+c/2, "br", "$S$") ;
