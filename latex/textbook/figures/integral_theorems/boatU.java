...
public class boatU extends Template {

     static {templateClass = new boatU() ; }

     public void setup() {
          filePrefix = "boatU" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.5 ;      // in inches
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(l*Math.sin(th)+1, yg+l*Math.cos(th),  "bl", "$\\vB$") ;
