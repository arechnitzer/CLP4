...
public class twoSurfaceA extends Template {

     static {templateClass = new twoSurfaceA() ; }
...
//          fTeXlabel3d(xm,-1,-1, "tr", "$x$") ;
          ...
          fArrow3d(cx, 1.3*cy,0, cx, 1.3*cy, 25) ;
          fTeXlabel3d(cx,1.3*cy,25, "br", "$\\hn$") ;
