...
public class phaseVortex2 extends Template {

     static {templateClass = new phaseVortex2() ; }

     public void setup() {
          filePrefix = "phaseVortex2" ;    
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0 ;      // in inches
          ysize = 2.0 ;   // in inches. 
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          r = 2.5 ; double x = r/Math.sqrt(2) ;
          fEllipticalArc(0, 0, r, r, 0, 315, OPEN) ;
