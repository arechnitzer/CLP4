...
public class phaseVortex4a extends Template {

     static {templateClass = new phaseVortex4a() ; }

     public void setup() {
          filePrefix = "phaseVortex4a" ;    
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0 ;      // in inches
          ysize = 2.0 ;   // in inches. 
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          {double[] xlist = {xmin, xmin, xmax, xmax} ;
           double[] ylist = {ymin, ymax, ymax, ymin} ;
           fPolygon(xlist, ylist, 4, FILLED) ;} 
          fEnv("psFillGray", 1.0) ;
          {double[] xlist = {0, 0, xmax, xmax} ;
           double[] ylist = {ymin, 0   , 0, ymin} ;
           fPolygon(xlist, ylist, 4, FILLED) ;} 
          fEnv("psFillGray", 0.0) ;
