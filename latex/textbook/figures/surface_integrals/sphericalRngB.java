...
public class sphericalRngB extends Template {

     static {templateClass = new sphericalRngB() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "sphericalRngB" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 3.0 ;    
          ysize = 2.5 ;  
