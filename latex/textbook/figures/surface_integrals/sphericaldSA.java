...
public class sphericaldSA extends Template {

     static {templateClass = new sphericaldSA() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          xh = Math.cos(th2*Math.PI/180);
          yh = Math.sin(th2*Math.PI/180);
          xv = Math.sin((0.6*phi1+0.4*phi2)*Math.PI/180);
          zv = Math.cos((0.6*phi1+0.4*phi2)*Math.PI/180);
          fArrow3d(r*xh*xv,r*yh*xv+30,r*zv,  r*xh*xv,r*yh*xv+2,r*zv) ;
          fTeXlabel3d(r*xh*xv,r*yh*xv+30,r*zv, "lc", "$a\\,d\\varphi$") ;


          xh = Math.cos((0.6*th1+0.4*th2)*Math.PI/180);
          yh = Math.sin((0.6*th1+0.4*th2)*Math.PI/180);
          xv = Math.sin(phi1*Math.PI/180);
          zv = Math.cos(phi1*Math.PI/180);
          fArrow3d(r*xh*xv,r*yh*xv,r*zv+50,  r*xh*xv,r*yh*xv,r*zv+2) ;
          fTeXlabel3d(r*xh*xv,r*yh*xv,r*zv+50, "bc", "$a\\sin\\varphi\\, d\\theta$") ;
