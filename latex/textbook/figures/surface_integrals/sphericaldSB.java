...
public class sphericaldSB extends Template {

     static {templateClass = new sphericaldSB() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "sphericaldSB" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.5 ;    
          ysize = 2.5 ;  
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(r2*xh*xv,r2*yh*xv+2,r2*zv+3, "lc", "$\\,a\\,d\\varphi$") ;


          fTeXlabel(30,32, "bc", "$a$") ;
          fTeXlabel(6,9, "bc", "$\\varphi$") ;
          fTeXlabel(16*1.5,5*1.5, "bc", "$d\\varphi$") ;
