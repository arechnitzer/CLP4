...
public class cylindrical extends Template {

     static {templateClass = new cylindrical() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "cylindrical" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 1.2 ;    
          ysize = 1.2 ;  
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          double a = 65 ;
          double r = 110 ;
          double th = Math.PI/5.0 ;
//          double th = 0 ;
          double thDeg = 180/5.0 ;
          ...
          fLine3d(0,0,0, x,y,0) ;
          fLine3d(x,y,0, x,y,z) ;
          fCurve(new circ3d(al, 0.5,   0,0,0, r/4.0,0,0, 0,r/4.0,0),
                 0,thDeg,OPEN)  ;
          ...
          fDisk3d(x,y,z, 3,3,FILLED) ; 
          fTeXlabel3d(x,y+5,z,  "lc", "$(x,y,z)$") ;
          fDisk3d(x,y,0, 3,3,FILLED) ; 
          fTeXlabel3d(x,y+5,0,  "lc", "$(x,y,0)$") ;
     ...
     public void fTeXlabel3d(double x, double y, double z,
