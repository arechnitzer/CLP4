...
public class saddleA extends Template {

     static {templateClass = new saddleA() ; }
...
//  General orthogonal projection.  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fDisk3d(x,y, Cx*x*x-Cy*y*y, rr, rr*aspect, FILLED) ;
          canvas.append( new fPsWrite(Blue+"\n")) ;
          fEnv("psFillColor", Blue) ;
          fEnv("lineWidth", 1.0) ;
          fCurve(new saddleX(proj,  Cx, Cy, 2), -12,3, OPEN)  ;
          double ux = -12 ;
          double uy = 0 ;
          double uz = 2*Cx*x*ux ;
          fArrow3d(x,y, z,  x+ux,y+uy, z+uz) ;
          fTeXlabel3d(x+ux,y+uy, z+uz, "cl", "$\\vT_v$") ;
          canvas.append( new fPsWrite(Red+"\n")) ;
          fEnv("psFillColor", Red) ;
          fCurve(new saddleY(proj,  Cx, Cy, -1), 1,5, OPEN)  ;
          double vx = 0 ;
          double vy = 3 ;
          double vz = -2*Cy*y*vy ;
          fArrow3d(x,y, z,  x+vx,y+vy, z+vz) ;
          fTeXlabel3d(x+vx,y+vy, z+vz, "cl", "$\\vT_u$") ;
          ...
          fArrow3d(x,y, z,  x-0.07*wx,y-0.07*wy, z-0.07*wz) ;
          fTeXlabel3d(x-0.07*wx,y-0.07*wy-0.2, z-0.07*wz, "cr", "$\\vn$") ;
     }
