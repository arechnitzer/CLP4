...
public class localGraphA extends Template {

     static {templateClass = new localGraphA() ; }

     public void setup() {
          filePrefix = "localGraphA" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 4.0*0.5 ;   
          ysize = 4.0*0.5 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fDisk(0,1, Math.sqrt(2), Math.sqrt(2), CLOSED) ;
          fTeXlabel(-1.3, 1.5, "br", "$x^2+y^2+(z-1)^2=2$") ;
