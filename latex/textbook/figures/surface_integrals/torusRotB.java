...
public class torusRotB extends Template {

     static {templateClass = new torusRotB() ; }
...
//  General orthogonal projection.  
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fCurve(new circ3d(proj,   0,R,0, 0,r,0, 0,0,r),
                 0,360,OPEN)  ;
          ...
          fDisk3d(0,R+y,z, rr, rr*aspect, FILLED ) ;
          fCurve(new circ3d(proj,   0,0,z, R+y,0,0, 0,R+y,0),
                 0,360,OPEN)  ;
          fEnv("psFillColor", Blue) ;
          fDisk3d(0,R,0, rr, rr*aspect, FILLED ) ;
