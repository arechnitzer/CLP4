...
public class sphericalPhi extends Template {

     static {templateClass = new sphericalPhi() ; }
...
//          double zm = 70 ;
          ...
          double R = 12 ;
          fCurve(new circ3d(proj,0,0,0, 0,0,R,   
                                R*Math.cos(th) , R*Math.sin(th),0), 
                                       0, phi*180/Math.PI, OPEN)  ;
          fTeXlabel3d(0.49*P[0], 0.28*P[1], 0.43*P[2], "bl", "$\\phi$") ;
          ...
          fCurve(new circ3d(proj,0,0,rho*Math.cos(phi), 
                                rho*Math.sin(phi),0,0,   
                                0 , rho*Math.sin(phi),0), 
                                0, 360, OPEN)  ;
